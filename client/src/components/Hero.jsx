          ...
          <div className="flex justify-center mb-4">
            <div className="relative w-full max-w-lg">
              ...
              <button
                ...
                className="absolute right-1 top-1/2 transform -translate-y-1/2 py-2 px-4 bg-primary  rounded text-white text-sm shadow hover:bg-blue-800 transition duration-300"
              >
                Search
              </button>
